...
import { setDefaultDeliveryAddress } from '@/store/slices/cart-slice';
			...
			>
				...
				>
					<Box>
						...
						<Typography variant='body1'>Add and manage the addresses you use often.</Typography>
					</Box>
											...
											render={({ field }) => (
												<Box>
													<FormControlLabel
														control={
															<Switch
																{...field}
																checked={field.value}
																disabled={!hasExistingAddresses && !editingAddress} // Disable toggle if it's first address
															/>
														}
													...
													{!hasExistingAddresses && !editingAddress && (
														...
														>
															Your first address will automatically be set as default
														</Typography>
													)}
												</Box>
											)}
			...
			>
				...
				<DialogContent>
					...
					<Typography
						...
						align='center'
					>
						Are you sure you want to delete this address? This action cannot be undone, and you won't be
						able to use this address for future deliveries. This will remove the address permanently.
					</Typography>
				</DialogContent>
				<DialogActions
					sx={{
